 ...
 *******************************************************************************/
package org.tuleap.mylyn.task.internal.agile.mock.connector.ui.util;
 ...
 */
public final class MylynMockConnectorUIMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.tuleap.mylyn.task.internal.agile.mock.connector.ui.util.messages"; //$NON-NLS-1$
	 ...
	 */
	private MylynMockConnectorUIMessages() {
