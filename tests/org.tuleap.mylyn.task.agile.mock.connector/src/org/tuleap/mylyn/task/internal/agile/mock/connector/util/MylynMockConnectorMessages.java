 ...
 *******************************************************************************/
package org.tuleap.mylyn.task.internal.agile.mock.connector.util;
 ...
 */
public final class MylynMockConnectorMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.tuleap.mylyn.task.internal.agile.mock.connector.util.messages"; //$NON-NLS-1$
	 ...
	 */
	private MylynMockConnectorMessages() {
