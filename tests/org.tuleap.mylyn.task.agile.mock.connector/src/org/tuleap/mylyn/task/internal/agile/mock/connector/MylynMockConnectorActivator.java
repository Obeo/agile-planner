 ...
 */
public class MylynMockConnectorActivator extends Plugin {

	/**
	 * The ID of the plugin.
	 */
	public static final String PLUGIN_ID = "org.tuleap.mylyn.task.agile.mock.connector"; //$NON-NLS-1$

	/**
	 * The sole instance of the activator.
	 */
	private static MylynMockConnectorActivator plugin;
	 ...
	 */
	public static MylynMockConnectorActivator getDefault() {
		return plugin;
	}
	...
	public static void log(Exception e, boolean blocker) {
		if (e == null) {
			throw new NullPointerException(MylynMockConnectorMessages
					.getString("MylynMockConnectorActivator.LogNullException")); //$NON-NLS-1$
		}
		...
		if (getDefault() == null) {
			...
			log(new Status(severity, PLUGIN_ID, severity, MylynMockConnectorMessages
					.getString("MylynMockConnectorActivator.ElementNotFound"), e)); //$NON-NLS-1$
		} else {
			int severity = IStatus.WARNING;
			if (blocker) {
				severity = IStatus.ERROR;
	...
	public static void log(IStatus status) {
		...
		if (status == null) {
			throw new NullPointerException(MylynMockConnectorMessages
					.getString("MylynMockConnectorActivator.LogNullStatus")); //$NON-NLS-1$
		}
	...
	public static void log(String message, boolean blocker) {
		if (getDefault() == null) {
			...
			if (errorMessage == null || "".equals(errorMessage)) { //$NON-NLS-1$
				errorMessage = MylynMockConnectorMessages
						.getString("MylynMockConnectorActivator.UnexpectedException"); //$NON-NLS-1$
			}
