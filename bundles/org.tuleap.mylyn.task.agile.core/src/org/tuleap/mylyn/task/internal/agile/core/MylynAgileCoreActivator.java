 ...
 */
public class MylynAgileCoreActivator extends Plugin {

	/**
	 * The ID of the plugin.
	 */
	public static final String PLUGIN_ID = "org.tuleap.mylyn.task.agile.core"; //$NON-NLS-1$
	 ...
	 */
	public static MylynAgileCoreActivator getDefault() {
		return plugin;
	}
	...
	public static void log(Exception e, boolean blocker) {
		if (e == null) {
			throw new NullPointerException(MylynAgileCoreMessages
					.getString("MylynAgileCoreActivator.LogNullException")); //$NON-NLS-1$
		}
		...
		if (getDefault() == null) {
			...
			log(new Status(severity, PLUGIN_ID, severity, MylynAgileCoreMessages
					.getString("MylynAgileCoreActivator.ElementNotFound"), e)); //$NON-NLS-1$
		} else {
			int severity = IStatus.WARNING;
			if (blocker) {
				severity = IStatus.ERROR;
	...
	public static void log(IStatus status) {
		...
		if (status == null) {
			throw new NullPointerException(MylynAgileCoreMessages
					.getString("MylynAgileCoreActivator.LogNullStatus")); //$NON-NLS-1$
		}
	...
	public static void log(String message, boolean blocker) {
		if (getDefault() == null) {
			...
			if (errorMessage == null || "".equals(errorMessage)) { //$NON-NLS-1$
				errorMessage = MylynAgileCoreMessages
						.getString("MylynAgileCoreActivator.UnexpectedException"); //$NON-NLS-1$
			}
