 ...
 */
public final class MylynAgileCoreMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.tuleap.mylyn.task.internal.agile.core.util.messages"; //$NON-NLS-1$
	 ...
	 */
	private MylynAgileCoreMessages() {
