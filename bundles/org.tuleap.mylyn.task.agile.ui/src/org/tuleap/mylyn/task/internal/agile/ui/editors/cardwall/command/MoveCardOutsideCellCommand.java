...
/**
 * The command to move a card between cells.
 * 
 * @author <a href="mailto:cedric.notot@obeo.fr">Cedric Notot</a>
 */
public class MoveCardOutsideCellCommand extends AbstractMoveCardCommand {
	 ...
	 *            not exist.
	 */
	public MoveCardOutsideCellCommand(CellContentEditPart cellContentEditPart, CardEditPart moved,
			CardEditPart after) {
