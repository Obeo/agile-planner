...
/**
 * Collapse and Expand figure.
 * 
 * @author <a href="mailto:firas.bacha@obeo.fr">Firas Bacha</a>
 */
public class CollapseExpandFigure extends Toggle {

	/**
	 * The state of the figure when its is unchecked.
	 */
	static final Image UNCHECKED = MylynAgileUIActivator.getImageDescriptor(IMylynAgileIcons.COLLAPSE_TSK)
			.createImage();

	/**
	 * The state of the figure when its is checked.
	 */
	static final Image CHECKED = MylynAgileUIActivator.getImageDescriptor(IMylynAgileIcons.EXPAND_TSK)
			.createImage();
	 ...
	 * @since 2.0
	 */
	public CollapseExpandFigure(String text) {
