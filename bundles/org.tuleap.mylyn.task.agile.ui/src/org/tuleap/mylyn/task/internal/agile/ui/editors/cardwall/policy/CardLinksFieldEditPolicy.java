...
/**
 * Edit policy for direct edit on links fields.
 *
 * @author <a href="mailto:firas.bacha@obeo.fr">Firas Bacha</a>
 */
public class CardLinksFieldEditPolicy extends DirectEditPolicy {
	...
	protected Command getDirectEditCommand(DirectEditRequest request) {
		...
		return new SetFieldValuesCommand(cardWrapper, attribute, Arrays.asList(text.split(", "))); //$NON-NLS-1$
	}
