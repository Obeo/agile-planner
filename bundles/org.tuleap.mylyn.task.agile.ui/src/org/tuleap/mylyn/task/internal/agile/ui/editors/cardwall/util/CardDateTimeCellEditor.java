...
public class CardDateTimeCellEditor extends CellEditor {
	 ...
	 *            The parent
	 */
	public CardDateTimeCellEditor(final Composite parent) {
	 ...
	 *            The style
	 */
	public CardDateTimeCellEditor(Composite parent, int style) {
		super(parent, style);
	}
	...
	protected Control createControl(Composite composite) {
		...
		dateTime = new DateWidget(composite, SWT.FLAT, "Date", true, 1); //$NON-NLS-1$
		updateDate();
